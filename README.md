...
## Getting started
To install PharmaPy, download and unzip the code from the release section in the develop branch, and then follow the instructions on the `install_instructions.txt` file.
